...
const NAV = [
  ...
  { section: "Procurement", items: [
    ...
    { to: "/rfqs", label: "RFQ & Quotations", hideFor: ["requester"] },
    { to: "/purchase-orders", label: "Purchase Orders", hideFor: ["requester"] },
    { to: "/grns", label: "Goods Receipt", hideFor: ["requester"] },
  ]},
  { section: "AP Automation", items: [
    { to: "/capture", label: "Capture Inbox", hideFor: ["requester"] },
    { to: "/match", label: "3-Way Match", hideFor: ["requester"] },
    { to: "/gst2b", label: "GST 2B Recon", hideFor: ["requester"] },
    { to: "/tds", label: "TDS Engine", pill: "194C·J·I", pillClass: "pill-purple", hideFor: ["requester"] },
    { to: "/approvals", label: "Approval Workflow", hideFor: ["requester"] },
    { to: "/liability", label: "Liability & JV", hideFor: ["requester"] },
    { to: "/payments", label: "Payment Batch", hideFor: ["requester"] },
    { to: "/advances", label: "Advances & Imprest", hideFor: ["requester"] },
  ]},
